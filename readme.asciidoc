...
= Governance for Datavault on Snowflake, BigQuery & Synapse by Acceliance
...
image:https://img.shields.io/badge/scripting-Jython%202.7-3776AB?logo=python&logoColor=white[Jython 2.7 macro,link=macros/generate_datavault_for_sprint.py]
image:https://img.shields.io/badge/Data%20Vault-HUB%20%7C%20LINK%20%7C%20SAT-blue[Data Vault artefacts]
image:https://img.shields.io/badge/targets-Snowflake%20%7C%20PostgreSQL%20%7C%20BigQuery%20%7C%20Synapse-29B5E8?logo=snowflake&logoColor=white[Target databases]
image:https://img.shields.io/badge/Acceliance%20modules-5.4.01-blue[Acceliance Modelio modules]

image:https://img.shields.io/badge/governance-sprint%20%2F%20attribute%20level-success[Sprint-level governance]
image:https://img.shields.io/badge/cartography-Excel%20round--trip-217346[Excel cartography round-trip]
image:https://img.shields.io/badge/licence-free%20to%20reuse-green[Free to reuse]
image:https://img.shields.io/badge/vendor-Acceliance-orange[Acceliance,link=https://www.acceliance.fr/en/,window=_blank]
image:https://img.shields.io/github/last-commit/acceliance/GovernanceForDatavault[Last commit,link=https://github.com/acceliance/GovernanceForDatavault/commits/main,window=_blank]

We are pleased to provide you with a link:https://github.com/acceliance/ModelioForDataGovernance[practice for governing] the Datavault model including **automatic datavault model generator**
...
It was first hard coded for Snowflake but now uses a type mapper for PostGre, Snowflake, BigQuery, Synapse (choose the proper target in the link:macros/generate_datavault_for_sprint.py[script])
...
=== Multi Satellite generation
It is possible to span UML attributes into different target Satellites (for instance to separate raw and business ruled columns)

To do so, the scripts is adapted to use Modelio stereotype. The stereotype is created in the module part of the Modelio project.
image:readme/gov-dv-017.png[The satellite stereotype] 

Then the stereotype is applied to one or several attributes in a class to span to different satellite. The name of the satellite is used for grouping the columns into the satellite.
image:readme/gov-dv-018.png[Using the satellite stereotype] 

The output satellite is hown as this:
image:readme/gov-dv-019.png[Satellite by name] 
